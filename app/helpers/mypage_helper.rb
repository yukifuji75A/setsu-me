module MypageHelper
  COMMON_TAG_STYLES = {
    ...
    "価値観" => "text-[#fb923c] bg-[rgba(251,146,60,0.14)] border-[rgba(251,146,60,0.3)] font-semibold",
    "対人スタンス" => "text-[#38bdf8] bg-[rgba(56,189,248,0.14)] border-[rgba(56,189,248,0.3)] font-semibold"
  }.freeze
